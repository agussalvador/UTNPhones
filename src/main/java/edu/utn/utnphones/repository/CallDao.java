...
public interface CallDao extends JpaRepository<Call, Long> {
    ...
    Long saveCall( @Param("pPhoneNumberOrigin") String phoneLineOrigin, @Param("pPhoneNumberDestination") String phoneLineDestination , @Param("pDuration") Integer duration,  @Param("pDate") LocalDateTime date );
    ...
    List<City> getTOP10MostCalledDestination(@Param("dni") String dni);
